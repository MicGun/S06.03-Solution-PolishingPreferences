...
//        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(Callback, callback);
//        itemTouchHelper.attachToRecyclerView(mRecyclerView);
    ...
    //TODO: Add drag、drop and swipe function

//    ItemTouchHelper.Callback callback = new SimpleCallback(ItemTouchHelper.UP |
...
//
//
//            mForecastAdapter.notifyItemMoved(position_dragged, position_target);
//
//            return true;
//        }
//
...
//    };
    ...
    ItemTouchHelper helper = new ItemTouchHelper(new SimpleCallback(ItemTouchHelper.UP |ItemTouchHelper.DOWN,
